...
public class ClienteController {
	...
	public String findAll(Model model) {
		...
		model.addAllAttributes(clientes);       //EJ: clave =keyclientes , valor =clientes
		
		return "listar-clientes";        // eso es el nombre del formulario ej. listar-clientes.html o listar-clientes.jsp
//	}catch (Exception e) {
